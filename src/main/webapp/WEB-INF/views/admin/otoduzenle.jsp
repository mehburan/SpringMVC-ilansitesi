 ...
 <jsp:include page="${request.contextPath}/menu"></jsp:include>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Otomobil İlan Düzenleme Sayfası 
      </h1>
      
    <div class>
    <h3>İlan Başlığı</h3>
    <form autocomplete="off" action='<s:url value="/otoduzenle"></s:url>' method="POST">
    
    <div class="input-group input-group-lg">
  <span class="input-group-addon" id="sizing-addon1">"Aa"</span>
  <input type="hidden" name="voidd" value='<c:out value="${ vo.getVoidd() }"></c:out>'>
  <input  type="text" class="form-control" name="vobaslik" value='<c:out value="${ vo.getVobaslik() }"></c:out>' placeholder="İlan Başlığı" aria-describedby="sizing-addon1">
  </div>
  <h3>İlan Açıklaması</h3>
  	<div class="input-group input-group-lg">
  	<span class="input-group-addon" id="sizing-addon1">"Aa"</span>
  	<input type="text" name="voacik" value='<c:out value="${ vo.getVoacik() }"></c:out>' class="form-control" placeholder="İlan Açıklaması" aria-describedby="sizing-addon1">
  	</div>
  	<h3>İlan Detayı</h3>
  	<div class="input-group input-group-lg">
  	<span class="input-group-addon" id="sizing-addon1">"Aa"</span>
  	<input type="text" name="vodetay" value='<c:out value="${ vo.getVodetay() }"></c:out>' class="form-control" placeholder="İlan Detayı" aria-describedby="sizing-addon1">
  	</div>
  	
<h3>İlan Fiyatı</h3>
  	<div class="input-group">
  <span class="input-group-addon">₺</span>
  <input name="vofiyat" type="text" value="${ vo.getVofiyat() }" class="form-control" aria-label="Amount (to the nearest dollar)">
...
<table class="table">
  <tr>
    ...
    <th class="tg-q1zm">İlan Resim Düzenle</th>
  </tr>
  ...
  <tr>
    ...
    <td><a href='<s:url value="/otoduzenle/${ vo.getVoidd() }"></s:url>' class="btn btn-info">Resim Düzenle</a></td>
