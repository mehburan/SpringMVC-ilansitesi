...
<div class="content-wrapper">
		...
		<section class="content">
			<!-- Info boxes -->
					<h1>Kiralık Ev İlanı Sayfası</h1>


							<c:if test="${not empty ukk }">

								<div id="myCarousel" class="carousel slide" data-ride="carousel">
									<!-- Indicators -->
									<ol class="carousel-indicators">
									<c:set var="count" value="1" scope="page" />
									<c:forEach items="${ ukk }" var="item">
...
<table class="table">
  ...
  <c:if test="${not empty ekiralik }">
  
  
  <tr>
    
    <td class="tg-yw4l"><c:out value="${ ekiralik.getEkbaslik() }"></c:out></td>
    <td class="tg-yw4l"><c:out value="${ ekiralik.getEkacik() }"></c:out></td>
    <td class="tg-yw4l"><c:out value="${ ekiralik.getEkdetay() }"></c:out></td>
    <td class="tg-yw4l"><c:out value="${ ekiralik.getEkfiyat() }"></c:out></td>
     <td class="tg-yw4l"><c:out value="${ ekiralik.getEkid() }"></c:out></td>
