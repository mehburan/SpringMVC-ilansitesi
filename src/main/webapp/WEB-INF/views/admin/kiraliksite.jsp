...
<div class="wrapper">
 ...
 <jsp:include page="${request.contextPath}/header"></jsp:include>
    ...
    <section class="content">
      <!-- Info boxes -->
      <form method="get" action='<s:url value="/kiralik"></s:url>'>
      <div class="content-wrapper">
        <h1>Kiralık Ev İlanları Sayfası</h1>
     <style type="text/css">
...
<table class="table">
  ...
  <tr>
    ...
    <td><a href='<s:url value="admin/kiralikilan/${ ek.getEkid() }"></s:url>' class="btn btn-success">İlana Git</a></td>
