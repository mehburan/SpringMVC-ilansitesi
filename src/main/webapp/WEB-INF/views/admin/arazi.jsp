...
<div class="wrapper">
 ...
 <jsp:include page="${request.contextPath}/menu"></jsp:include>
  ...
  <div class="content-wrapper">
    ...
    <div class>
    <h3>İlan Başlığı</h3>
    <form autocomplete="off" action='<s:url value="/arazi"></s:url>'
					method="post">
    <div class="input-group input-group-lg">
  <span class="input-group-addon" id="sizing-addon1">"Aa"</span>
  <input type="text" class="form-control" name="vabaslik" placeholder="İlan Başlığı" aria-describedby="sizing-addon1">
  </div>
  <h3>İlan Açıklaması</h3>
  	<div class="input-group input-group-lg">
  	<span class="input-group-addon" id="sizing-addon1">"Aa"</span>
  	<input type="text" name="vaacik" class="form-control" placeholder="İlan Açıklaması" aria-describedby="sizing-addon1">
  	</div>
  	<h3>İlan Detayı</h3>
  	<div class="input-group input-group-lg">
  	<span class="input-group-addon" id="sizing-addon1">"Aa"</span>
  	<input type="text" name="vadetay" class="form-control" placeholder="İlan Detayı" aria-describedby="sizing-addon1">
  	</div>
  	<h3>İlan Fotoğrafları</h3>
  	<div class="col-md-12">
  	<c:forEach var="item" items="${ uaz }">
...
<h3>İlan Fiyatı</h3>
  ...
  <input name="vafiyat" type="text" class="form-control" aria-label="Amount (to the nearest dollar)">
...
<table class="table">
  ...
  <tr>
    ...
    <td><a href='<s:url value="/sil/${ vz.getVaid() }"></s:url>' class="btn btn-danger">Sil</a></td>
	<td><a href='<s:url value="/araziduzenle/${ vz.getVaid() }"></s:url>' class="btn btn-info">Düzenle</a></td>
