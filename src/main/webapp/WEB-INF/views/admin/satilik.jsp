 ...
 <jsp:include page="${request.contextPath}/menu"></jsp:include>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Satılık İlan Sayfası 
      </h1>
      
    <div class>
    <h3>İlan Başlığı</h3>
    <form autocomplete="off" action='<s:url value="/satilik"></s:url>'method="post">
    <div class="input-group input-group-lg">
  <span class="input-group-addon" id="sizing-addon1">"Aa"</span>
  <input type="text" class="form-control" name="esbaslik" placeholder="İlan Başlığı" aria-describedby="sizing-addon1">
  </div>
  <h3>İlan Açıklaması</h3>
  	<div class="input-group input-group-lg">
  	<span class="input-group-addon" id="sizing-addon1">"Aa"</span>
  	<input type="text" name="esacik" class="form-control" placeholder="İlan Açıklaması" aria-describedby="sizing-addon1">
  	</div>
  	<h3>İlan Detayı</h3>
  	<div class="input-group input-group-lg">
  	<span class="input-group-addon" id="sizing-addon1">"Aa"</span>
  	<input type="text" name="esdetay" class="form-control" placeholder="İlan Detayı" aria-describedby="sizing-addon1">
  	</div>

	<h3>İlan Fotoğrafları</h3>
  	<div class="col-md-12">
  	<c:forEach var="item" items="${ uls }">
...
<h3>İlan Fiyatı</h3>
  ...
  <input name="esfiyat" type="text" class="form-control" aria-label="Amount (to the nearest dollar)">
...
<table class="table">
  ...
  <tr>
    ...
    <td><a href='<s:url value="/satilik/sil/${ es.getEsid() }"></s:url>' class="btn btn-danger">Sil</a></td>
	<td><a href='<s:url value="/satduzenle/${ es.getEsid() }"></s:url>' class="btn btn-info">Düzenle</a></td>
	<td><a href='<s:url value="/resimekle/${  es.getEsid() }"></s:url>' class="btn btn-warning">Resim Ekle</a></td>
  </tr>
  </c:forEach>
</c:if>
</table>
