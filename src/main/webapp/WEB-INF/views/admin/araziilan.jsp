...
<div class="content-wrapper">
		...
		<section class="content">
			<!-- Info boxes -->
					...
					<h1>Satılık Arazi İlanı Sayfası</h1>
...
<table class="table">
  ...
  <c:if test="${not empty varazi }">
  
  
  <tr>
    
    <td class="tg-yw4l"><c:out value="${ varazi.getVabaslik() }"></c:out></td>
    <td class="tg-yw4l"><c:out value="${ varazi.getVaacik() }"></c:out></td>
    <td class="tg-yw4l"><c:out value="${ varazi.getVadetay() }"></c:out></td>
    <td class="tg-yw4l"><c:out value="${ varazi.getVafiyat() }"></c:out></td>
     <td class="tg-yw4l"><c:out value="${ varazi.getVaid() }"></c:out></td>
