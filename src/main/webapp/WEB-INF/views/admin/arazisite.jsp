...
<div class="wrapper">
 ...
 <jsp:include page="${request.contextPath}/header"></jsp:include>
    ...
    <section class="content">
      <!-- Info boxes -->
      <form method="get" action='<s:url value="/arazi"></s:url>'>
      <div class="content-wrapper">
        <h1>Arazi Araç İlanları Sayfası</h1>
     <style type="text/css">
...
<table class="table">
  ...
  <td><a href='<s:url value="admin/araziilan/${ vz.getVaid() }"></s:url>' class="btn btn-success">İlana Git</a></td>
