		...
		<section class="content">
			<!-- Info boxes -->
					<h1>İlan Sayfası</h1>
							...
							<c:if test="${not empty uss }">

								<div id="myCarousel" class="carousel slide" data-ride="carousel">
									<!-- Indicators -->
									<ol class="carousel-indicators">
									<c:set var="count" value="1" scope="page" />
									<c:forEach items="${ uss }" var="item">
					  ...
					  <h1>Satılık Ev İlanı Sayfası</h1>
...
<table class="table">
  ...
  <c:if test="${not empty esatilik }">
  
  
  <tr>
    
    <td class="tg-yw4l"><c:out value="${ esatilik.getEsbaslik() }"></c:out></td>
    <td class="tg-yw4l"><c:out value="${ esatilik.getEsacik() }"></c:out></td>
    <td class="tg-yw4l"><c:out value="${ esatilik.getEsdetay() }"></c:out></td>
    <td class="tg-yw4l"><c:out value="${ esatilik.getEsfiyat() }"></c:out></td>
     <td class="tg-yw4l"><c:out value="${ esatilik.getEsid() }"></c:out></td>
